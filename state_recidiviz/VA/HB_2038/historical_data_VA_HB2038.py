...
transitions_data = pd.concat(
    [
        transitions_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/VA/HB_2038/VAHB2038_transitions_data.csv"
        ),
    ]
)
...
total_population_data = pd.concat(
    [
        ...
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/VA/HB_2038/VAHB2038_total_population.csv"
        ),
    ]
)
...
upload_spark_model_inputs(
    ...
    transitions_data,
    total_population_data,
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/VA/HB_2038/VAHB2038_model_inputs.yaml",
)
