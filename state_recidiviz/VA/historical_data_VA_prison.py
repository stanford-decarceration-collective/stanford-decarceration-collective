...
historical_sentences = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/VA/VA_data/processed_va_historical_sentences_v2.csv"
)
...
upload_spark_model_inputs(
    ...
    transitions_data,
    pd.DataFrame(),
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/VA/VA_prison_model_inputs.yaml",
)
