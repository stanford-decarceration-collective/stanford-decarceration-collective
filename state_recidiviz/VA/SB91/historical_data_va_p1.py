...
transitions_data = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/VA/SB91/va_p1_transitions.csv"
)
outflows_data = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/VA/SB91/va_p1_outflows.csv"
)
total_population_data = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/VA/SB91/va_p1_population.csv"
)
...
upload_spark_model_inputs(
    ...
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/NY/mms/ny_state_prison_model_inputs",
)
