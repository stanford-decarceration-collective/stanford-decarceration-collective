...
outflows = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/LA/HB_479/outflows.csv"
)
population = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/LA/HB_479/population.csv"
)
monthly_transitions = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/LA/HB_479/transitions.csv"
)
...
upload_spark_model_inputs(
    ...
    monthly_transitions,
    monthly_population,
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/LA/HB_479/LA_HB479_model_inputs.yaml",
)
