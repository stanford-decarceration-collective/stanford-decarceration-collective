...
transitions_data = pd.concat(
    [
        transitions_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/AZ/AZ_data/AZ_transitions.csv"
        ),
    ]
)
...
yearly_outflows_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/LA/LA_data/Habitual Offender Prison Admissions Data-Table 1.csv"
)
...
yearly_total_population_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/LA/LA_data/Habitual Offender Total Population Data-Table 1.csv"
)
...
upload_spark_model_inputs(
    ...
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/LA/LA_prison_habitual_model_inputs.yaml",
)
