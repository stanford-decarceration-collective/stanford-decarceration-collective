...
transitions_data = pd.concat(
    [
        transitions_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/IA/IAHSB6_transitions_data.csv"
        ),
    ]
)
...
outflows_data = pd.concat(
    [
        outflows_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/IA/IAHSB6_outflows_data.csv"
        ),
    ]
)
...
total_population_data = pd.concat(
    [
        ...
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/IA/IAHSB6_total_population_data.csv"
        ),
    ]
)
...
upload_spark_model_inputs(
    ...
    transitions_data,
    total_population_data,
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IA/IAHSB6_model_inputs.yaml",
)
