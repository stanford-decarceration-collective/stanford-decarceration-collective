...
mms = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/NY/mms/crime_to_mm.csv"
)
...
dfs = {
    year: pd.read_csv(
        "recidiviz/calculator/modeling/population_projection/state_recidiviz/NY/sentencing_data/inmates"
        + str(year)
        + ".csv",
        index_col=0,
...
upload_spark_model_inputs(
    ...
    transitions,
    pop_out,
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/NY/mms/ny_state_prison_model_inputs.yaml",
)
