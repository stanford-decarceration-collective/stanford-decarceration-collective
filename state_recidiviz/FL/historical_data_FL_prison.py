...
outflows_data_2019 = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FL/2019-admissions-data.csv"
)
outflows_data_2018 = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FL/2018-admissions-data.csv"
)
...
prison_to_release_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FL/transitions-data.csv"
)
release_to_prison_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FL/transitions-recidivism.csv"
)
...
upload_spark_model_inputs(
    ...
    transitions_data,
    pd.DataFrame(),
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FL/FL_prison_model_inputs.yaml",
)
