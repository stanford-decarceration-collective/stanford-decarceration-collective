...
total_population_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/CA/parole_total_population.csv"
)
...
#     f'recidiviz/calculator/modeling/population_projection/state_recidiviz/{state}/preprocessed_data_{state}_{primary_compartment}.csv')
...
upload_spark_model_inputs(
    ...
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/CA/PO_incentives/CA_parole_model_inputs.yaml",
)
