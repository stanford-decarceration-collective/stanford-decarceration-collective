...
transitions_data = pd.concat(
    [
        transitions_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/OK/OK_data/Transitions Data-Table 1.csv"
        ),
    ]
)
...
outflows_data = pd.concat(
    [
        outflows_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/OK/OK_data/Outflows Data-Table 1.csv"
        ),
    ]
)
...
upload_spark_model_inputs(
    ...
    transitions_data,
    pd.DataFrame(),
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/OK/OK_earned_credits/OK_probation_model_inputs_average_cost.yaml",
)
