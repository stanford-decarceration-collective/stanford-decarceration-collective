...
prison_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/RAE Prison Transitions Data-Table 1.csv"
)

probation_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/RAE Probation Transitions Data-Table 1.csv"
)

release_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/RAE Release Transitions Data-Table 1.csv"
)
...
yearly_outflows_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/RAE Prison Admissions Data-Table 1.csv"
)
...
yearly_total_population_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/RAE Total Prison Population Data-Table 1.csv"
)
...
upload_spark_model_inputs(
    ...
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_prison_RAE_model_inputs.yaml",
)
