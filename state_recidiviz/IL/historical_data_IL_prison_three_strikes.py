...
prison_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/Three Strikes Prison Transitions Data (Baseline)-Table 1.csv"
)

probation_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/Three Strikes Probation Transitions Data (Baseline)-Table 1.csv"
)

release_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/Three Strikes Release Transitions Data (Baseline)-Table 1.csv"
)
...
yearly_outflows_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/Three Strikes Prison Admissions Data-Table 1.csv"
)
...
upload_spark_model_inputs(
    ...
    transitions_data,
    pd.DataFrame(),
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_prison_three_strikes_model_inputs.yaml",
)
