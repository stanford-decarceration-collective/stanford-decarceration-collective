...
prison_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/EMPS Prison Transitions Data-Table 1.csv"
)

probation_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/EMPS Probation Transitions Data-Table 1.csv"
)

release_transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/EMPS Release Transitions Data-Table 1.csv"
)
...
outflows_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/EMPS Prison Admissions Data-Table 1.csv"
)
...
total_population_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_data/EMPS Total Prison Population Data-Table 1.csv"
)
...
upload_spark_model_inputs(
    ...
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/IL/IL_prison_EMPS_model_inputs.yaml",
)
