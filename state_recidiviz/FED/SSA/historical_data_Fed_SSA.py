...
ussc = pd.read_spss(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FED/SSA/USSC_data.sav"
)
...
yearly_outflows = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FED/SSA/outflows.csv"
)
yearly_population = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FED/SSA/population.csv"
)
...
release_transitions = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FED/SSA/transitions.csv"
)
...
upload_spark_model_inputs(
    ...
    transitions,
    population,
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/FED/SSA/Fed_SSA_model_inputs.yaml",
)

##### b) Saving tables (commented out, uncomment to save the processed tables as CSVs)
# outflows.to_csv('~/Documents/spark/pulse-data/recidiviz/calculator/modeling/population_projection/state_recidiviz/Federal/SSA/final_outflows.csv', index = False)
# population.to_csv('~/Documents/spark/pulse-data/recidiviz/calculator/modeling/population_projection/state_recidiviz/Federal/SSA/final_population.csv', index = False)
# transitions.to_csv('~/Documents/spark/pulse-data/recidiviz/calculator/modeling/population_projection/state_recidiviz/Federal/SSA/final_transitions.csv', index = False)
