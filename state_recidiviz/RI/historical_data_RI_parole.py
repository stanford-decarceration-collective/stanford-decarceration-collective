...
transitions_data = pd.concat(
    [
        transitions_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/RI/RI_data/Parole Transitions Data-Table 1.csv"
        ),
    ]
)
...
outflows_data = pd.concat(
    [
        outflows_data,
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/RI/RI_data/Parole Outflows Data-Table 1.csv"
        ),
    ]
)
...
total_population_data = pd.concat(
    [
        ...
        pd.read_csv(
            "recidiviz/calculator/modeling/population_projection/state_recidiviz/RI/RI_data/Parole Total Population Data-Table 1.csv"
        ),
    ]
)
...
upload_spark_model_inputs(
    ...
    transitions_data,
    total_population_data,
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/RI/RI_parole_model_inputs.yaml",
)
