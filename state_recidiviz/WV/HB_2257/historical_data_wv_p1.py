...
transitions_data = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/WV/HB_2257/wv_p1_transitions.csv"
)
outflows_data = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/WV/HB_2257/wv_p1_outflows.csv"
)
...
upload_spark_model_inputs(
    ...
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/WV/HB_2257/WV_hb2257_model_inputs.yaml",
)
