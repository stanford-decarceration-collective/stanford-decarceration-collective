...
transitions_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/MS/SB_2123_Parole_Eligibility/ms_transitions.csv"
)
outflows_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/MS/SB_2123_Parole_Eligibility/ms_outflows.csv"
)
total_population_data = pd.read_csv(
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/MS/SB_2123_Parole_Eligibility/ms_population.csv"
)
...
upload_spark_model_inputs(
    ...
    "recidiviz/calculator/modeling/population_projection/state_recidiviz/MS/SB_2123_Parole_Eligibility/MS_prison_model_inputs.yaml",
)
