...
outflows = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/KY/Pretrial/outflows.csv"
)
transitions = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/KY/Pretrial/transitions.csv"
)
population = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/KY/Pretrial/population.csv"
)
...
upload_spark_model_inputs(
    ...
    transitions,
    population,
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/KY/Pretrial/KY_pretrial_model_inputs.yaml",
)
