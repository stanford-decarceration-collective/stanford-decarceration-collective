...
outflows = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/MI/HB_4670/outflows.csv"
)
transitions = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/MI/HB_4670/transitions.csv"
)
population = pd.read_csv(
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/MI/HB_4670/population.csv"
)
...
upload_spark_model_inputs(
    ...
    transitions,
    population,
    "./recidiviz/calculator/modeling/population_projection/state_recidiviz/MI/HB_4670/MI_HB4670_model_inputs.yaml",
)
